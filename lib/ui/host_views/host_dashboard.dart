...
class _HostDashboardState extends State<HostDashboard> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (jsonUsuario != null) {
        ...
        final fetchedHouses = await houseRepository.getHouses(usuario.userId);
  ...
  void _showFormDialog() {
    showDialog(
      context: context,
      builder: (_) => NuevoAlojamientoForm(
        userId: user!.userId,
        onSubmit: () async {
          setState(() {
            loading = true;
          });
          houses = await houseRepository.getHouses(user!.userId);
          setState(() {
            loading = false;
          });
        },
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              // Acción al tocar el ListTile, por ejemplo, navegar a una vista de detalles
                            },
                          ),
                        );
                      },
